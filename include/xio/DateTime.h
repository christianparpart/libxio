...
XIO_API bool operator==(const DateTime& a, const DateTime& b);
XIO_API bool operator!=(const DateTime& a, const DateTime& b);
XIO_API bool operator<=(const DateTime& a, const DateTime& b);
XIO_API bool operator>=(const DateTime& a, const DateTime& b);
XIO_API bool operator<(const DateTime& a, const DateTime& b);
...
XIO_API TimeSpan operator-(const DateTime& a, const DateTime& b);
XIO_API DateTime operator+(const DateTime& a, const TimeSpan& b);
XIO_API DateTime operator-(const DateTime& a, const TimeSpan& b);
